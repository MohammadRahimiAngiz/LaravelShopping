...
')
     ...
     */ 
        ...
        public static function has($key)
        {
                        /** @var \App\Services\Cart\CartService $instance */
                        return $instance->has($key);
        }
                    /**
         * 
         ...
         * @param array $value
         * @param null $obj
         * @return \App\Services\Cart\CartService 
         * @static 
         */ 
        public static function put($value, $obj = null)
        {
                        /** @var \App\Services\Cart\CartService $instance */
                        return $instance->put($value, $obj);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function update($key, $options)
        {
                        /** @var \App\Services\Cart\CartService $instance */
                        return $instance->update($key, $options);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function get($key, $withRelationShip = true)
        {
                        /** @var \App\Services\Cart\CartService $instance */
                        return $instance->get($key, $withRelationShip);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setCodeVerified($codeVerified)
        {
                        /** @var \PayPing\Authorization $instance */
                        return $instance->setCodeVerified($codeVerified);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getCodeVerified()
        {
                        /** @var \PayPing\Authorization $instance */
                        return $instance->getCodeVerified();
        }
                    /**
         * 
         *
         ...
         * 
         *
         * @param \PayPing\Client $restCall
         * @static 
         */ 
        public static function setRestCall($restCall)
        {
                        /** @var \PayPing\Authorization $instance */
                        return $instance->setRestCall($restCall);
        }
                    /**
         ...
         * @static 
         */ 
        public static function getAuthLink($scopes = [], $state = null)
        {
                        /** @var \PayPing\Authorization $instance */
                        return $instance->getAuthLink($scopes, $state);
        }
                    /**
...
namespace  { 
            ...
            class Cart extends \App\Services\Cart\Cart {}
            class Flare extends \Facade\Ignition\Facades\Flare {}
            class Authorization extends \PayPing\Laravel\Facade\Authorization {}
